...
import static org.fix4j.meta.FixFieldMeta.fixFieldMeta;
import static org.fix4j.meta.FixFieldMeta.fixGroupMeta;

/**
 * I can scan Java classes annotated with fix4j annotations and build FIX mappings metadata. The FixMetaRepositoryImpl is used to optimise the scanning process, so that each class is scanned only once.
 *
