...
/**
 * This is a specific implementation of AbstractMetaFixAdapter that can serve only one
 * type of message or domain objects. A separate instance of GenericFixAdapter is required for each
 * domain object type that needs to be translated to/from a FIX message object of type M.
 *
