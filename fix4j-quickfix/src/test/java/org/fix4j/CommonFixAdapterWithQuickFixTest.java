...
import org.fix4j.quickfix.FixMetaDataDictionary;
...
import static org.fix4j.quickfix.test.data.TestModels.*;

public class CommonFixAdapterWithQuickFixTest {
    private final FixMetaRepositoryImpl fixMetaRepository = new FixMetaRepositoryImpl("org.fix4j");
